...
- **Fork** this repo from GitHub (oharac/esm244_w2024_lab1)
- Clone to create a version controlled R project 
- Create a new Quarto document in the project called `lab_1_yourinitials` (e.g. mine will be `lab_1_cco`)
...
Reset chunk options for this chunk! 
```{r setup}
library(tidyverse)
library(here)
library(sf)
